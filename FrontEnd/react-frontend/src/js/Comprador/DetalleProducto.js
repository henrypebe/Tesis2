...
export default function DetalleProducto({
  setMostrarDetalleProducto,
  setMostrarProductos,
  setMostrarMetodoPago,
  setMostrarOpcionCarrito,
  setMostrarCarrito,
  ProductoSeleccionado,
  conteoCarritoCompra,
  setConteoCarritoCompra,
  setProductos,
  productos
}) {
    ...
    >
      ...
      >
        {ProductoSeleccionado.tiendaFoto ? (
          <img
            src={ProductoSeleccionado.tiendaFoto}
            alt="Descripción de la imagen tienda"
            style={{
              height: "70px",
              borderRadius: "12px",
              marginLeft: "20px",
      ...
      >
        ...
        >
          ...
          >
            {ProductoSeleccionado.nombre} {ProductoSeleccionado.tipoProducto === "Vestimenta"? ` - ${selectedSize}`:""}
          </Typography>
          ...
          <Typography
            sx={{
              ...
              justifyContent: "center",
              marginTop: "5px",
              height: ProductoSeleccionado.cantidadOferta > 0 ? "20%" : "30%",
              display: "flex",
              alignItems: "center",
            }}
          >
          ...
          >
            <b>
              Costo de envío: S/.{ProductoSeleccionado.costoEnvio.toFixed(2)} -
              Tiempo de envío: {ProductoSeleccionado.fechaEnvio}
            </b>
          </Typography>
          <Typography
            sx={{
      ...
      <Box sx={{ marginBottom: "10px", height: "37%" }}>
        ...
        >
          ...
          {ProductoSeleccionado.descripcion !== "NE"
      ...
      >
        ...
        <Button
          ...
          color="success"
          sx={{ width: "50%" }}
          onClick={handleChangeMétodoPago}
        >
          Pagar ahora
        </Button>
      </Box>
