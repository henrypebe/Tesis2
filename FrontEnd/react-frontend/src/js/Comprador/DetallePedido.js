...
export default function DetallePedido({setMostrarDetallePedido, setMostrarPedidos, setMostrarSeguimiento}) {
    ...
    return (
    <Box sx={{width:"87.6%", marginTop:"-1.9px", height:"83.8vh", padding:"20px"}}>
